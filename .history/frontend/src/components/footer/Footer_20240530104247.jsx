    ...
    <div className="footer" id="footer">
      <div className="footer-content">
        <div className="footer-content-left">
          <p>
          Ordering food delivery in Tel Aviv is easy and can help get rid of your food craving quick. It doesn’t matter if you’re staying in a hotel, an Airbnb, or are just don’t want to leave the houses.
          </p>
